...
<body>
  <div class="site-shell">
    <header class="site-header">
      ...
      <label class="nav-trigger" for="nav-toggle"
        aria-label="Menu openen"><span></span><span></span><span></span></label>
    ...
    <main class="page-main dynamic-fullwidth-main">
      <section class="content-panel dynamic-content-panel dynamic-form-panel">
        ...
        <form class="contact-form" action="#" method="post">
          ...
          <div class="field full"><label for="message">Bericht</label><textarea id="message" name="message"></textarea>
          </div>
          <button class="submit-btn" type="submit">Verzenden</button>
          <p class="recaptcha dynamic-recaptcha">Deze site wordt beschermd door reCAPTCHA. Het <a
              href="privacy.php">privacybeleid</a> en de <a href="terms.php">algemene voorwaarden</a> van Google zijn
            van toepassing.</p>
        </form>
      </section>
    </main>
  ...
  <footer class="site-footer">
    ...
    <div><a href="terms.php">Algemene voorwaarden</a> <a href="complain.php">Klachtenportaal</a> <a
        href="privacy.php">Privacybeleid</a></div>
  </footer>
