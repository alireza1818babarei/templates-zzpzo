...
<body>
  <div class="site-shell">
    <header class="site-header">
      <a class="brand" href="index.php" id="">
    ...
    <section class="hero">
      ...
      <figure class="hero-media"><img src="<?php echo htmlspecialchars($heroImageUrl); ?>" alt="Startpagina"></figure>
    </section>
    <main class="page-main dynamic-fullwidth-main ">
      <section class="content-panel dynamic-content-panel">
        <div class="dynamic-txt-content zz-home-text-wrap">
          <?php
          $filePath = 'home.txt';
          if (file_exists($filePath)) {
            echo nl2br(htmlspecialchars(file_get_contents($filePath)));
