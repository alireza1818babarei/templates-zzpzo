  ...
  <div class="zz-nav-inner">
    ...
    <div class="zz-main-menu-wrap">
      <ul class="zz-main-menu">
        <li><a class="active" href="index.php">Startpagina</a></li>
...
<div class="zz-hero-container">
  <section id="home" class="parallax-section zz-hero-section" style="background-image: url('<?php echo htmlspecialchars($bannerUrl); ?>');">
    <div class="col-md-offset-1 col-md-10 col-sm-12">
      <div class="home-wrapper">
        <h1 class="wow fadeInUp" data-wow-delay="0.4s">Startpagina</h1>
