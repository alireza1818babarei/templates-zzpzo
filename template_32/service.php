    ...
    <div class="row">
      <div class="col-12">
        <nav class="navbar navbar-expand-md navbar-light">
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#tmMainNav" aria-controls="tmMainNav" aria-expanded="false" aria-label="Navigatie openen/sluiten">
...
<li class="nav-item active">
                    <a class="nav-link current" href="service.php">Diensten</a>
                  </li>
<li class="nav-item ">
...
<section class="zz-hero-section" style="background-image: url('<?php echo htmlspecialchars($bannerUrl); ?>');">
  <div class="zz-hero-content">
    <h1 class="zz-hero-title">Diensten</h1>
  </div>
</section>

<section class="container zz-dynamic-section">
  <div class="zz-dynamic-wrap">
    <h2 class="zz-dynamic-title">Diensten</h2>
