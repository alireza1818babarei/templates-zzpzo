...
?>
    ...
    <!-- Hero section -->
    <section id="" class="text-white tm-font-big tm-parallax" style="background: <?php echo $bannerUrl; ?>">
      <!-- Navigation -->
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav" style="background: #ccc;">              
        <div class="container">   
          <div class="tm-next">
 ...
 <!--       <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">Home</h2>
