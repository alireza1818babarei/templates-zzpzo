  ...
  <div class="tm-container">
    <div class="tm-container-inner">
      ...
      <section class="zz-hero-section"
        style="background-image: url('img/slopa-bottom-line.png'), url('<?php echo htmlspecialchars($bannerUrl); ?>');">
      ...
      <section class="zz-form-section">
        <div class="container">
          <div class="zz-form-panel">
            <div class="row">
              <h2 class="col-sm-12 text-left mb-5">Contactgegevens</h2>
            </div>
            <div class="row mb-4">
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 pb-5 zz-contact-text">
