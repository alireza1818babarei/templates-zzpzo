...
<body class="zz-form-page" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
  ...
  <section id="home" class="main" style="background-image: url('<?= htmlspecialchars($bannerUrl) ?>');">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="home-thumb"><h1 class="wow fadeInUp" data-wow-delay="0.6s">Contact</h1></div>
        </div>
      </div>
    </div>
  </section>

  <section class="zz-form-content-section" style="min-height: 300px;background: #fff;padding-top: 30px;">
    <div class="overlay">
      <div class="container">
        <div class="row">
