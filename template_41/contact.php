...
?> - Contact</title>
  ...
  <style>
    ...
    @media(max-width:767px){.dynamic-form-panel,.dynamic-form-text{height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important}.contact-form input,.contact-form textarea,.contact-form button{max-width:100%;box-sizing:border-box}}
  </style>
</head>
<body><div class="site-shell">
  <header class="site-header">
    <a class="brand" href="index.php" id="brandLogo"><img src="logo.png?id=<?php echo filemtime('logo.png'); ?>" alt="Logo" onerror="this.remove();"></a>
    <input class="nav-toggle" id="nav-toggle" type="checkbox">
    <label class="nav-trigger" for="nav-toggle" aria-label="Menu openen"><span></span><span></span><span></span></label>
    <nav class="main-nav" aria-label="Hoofdnavigatie">
      <a href="index.php">Startpagina</a><a href="about.php">Over ons</a><a href="service.php">Diensten</a><a class="active" href="contact.php">Contact</a>
    </nav>
  </header>
<?php
...
?></div>
    ...
    <form class="contact-form" action="" method="post">
      ...
      <div class="field"><label for="phone">Telefoon</label><input id="phone" name="phone" type="tel" value="<?php echo htmlspecialchars($formPhone); ?>" maxlength="50" autocomplete="tel"></div>
      <div class="field"><label for="email">E-mail</label><input id="email" name="email" type="email" value="<?php echo htmlspecialchars($formEmail); ?>" maxlength="254" autocomplete="email" required></div>
...
<footer class="site-footer"><div><p>Auteursrecht &copy; <?php echo date('Y'); ?> ZZpzo</p></div><div><a href="terms.php">Algemene voorwaarden</a> <a href="complain.php">Klachtenportaal</a> <a href="privacy.php">Privacybeleid</a></div></footer>
