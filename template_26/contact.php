...
<?php
$defaultBanner = "images/maison-doree-06.jpg";
...
<section class="hero zz-hero">
    <div class="hero-content">
        <h1 class="heading-display hero-title zz-hero-title">Contact</h1>
    </div>
    <div class="hero-image">
        <img class="zz-hero-single-image" src="<?php echo htmlspecialchars($bannerUrl); ?>" alt="Contact">
    </div>
</section>
    ...
    <div class="container">
        <div class="contact-grid">
            <div class="contact-content">
                ...
                <h2 class="heading-display contact-title">Contact</h2>
