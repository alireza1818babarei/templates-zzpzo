...
<a href="service.php" class="active">Diensten</a>
...
<?php
$defaultBanner = "images/maison-hero-03.jpg";
...
<section class="hero zz-hero">
    <div class="hero-content">
        <h1 class="heading-display hero-title zz-hero-title">Diensten</h1>
    </div>
    <div class="hero-image">
        <img class="zz-hero-single-image" src="<?php echo htmlspecialchars($bannerUrl); ?>" alt="Diensten">
    </div>
</section>
...
<section class="zz-dynamic-section">
    <div class="container">
        <div class="zz-dynamic-card">
            <h2 class="heading-display zz-dynamic-title">Diensten</h2>
