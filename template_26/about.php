...
<body>
    ...
    <?php
    $defaultBanner = "images/maison-hero-02.jpg";
    ...
    <section class="hero zz-hero">
        <div class="hero-content">
            <h1 class="heading-display hero-title zz-hero-title">Over ons</h1>
        </div>
        <div class="hero-image">
            <img class="zz-hero-single-image" src="<?php echo htmlspecialchars($bannerUrl); ?>" alt="Over ons">
        </div>
    </section>
    ...
    <section class="zz-dynamic-section">
        <div class="container">
            <div class="zz-dynamic-card">
                <h2 class="heading-display zz-dynamic-title">Over ons</h2>
