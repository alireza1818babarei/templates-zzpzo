...
<head>
  ...
  <meta name="description" content="<?= htmlspecialchars($siteTitle, ENT_QUOTES, 'UTF-8') ?> - Klachtenportaal" />
  ...
  <style>
    ...
    @media screen and (max-width:736px){#complain .zzpzo-rich-text,#complain .box{height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important}}
  </style>
</head>
<body class="is-preload zzpzo-responsive-page">
  <header id="header">
    ...
    <nav aria-label="Primaire navigatie"><ul><li><a href="index.php">Startpagina</a></li><li><a href="about.php">Over ons</a></li><li><a href="service.php">Diensten</a></li><li><a href="contact.php">Contact</a></li></ul></nav>
  </header>
  <?php
  $defaultBanner = 'img/banner-bg.jpg';
  $bannerFile = 'complainimage.txt';
  ...
  ?>
  <section id="complain-hero" class="main style1 dark fullscreen zzpzo-page-hero" style="background-image:linear-gradient(rgba(0,0,0,.38),rgba(0,0,0,.38)),url('<?= htmlspecialchars($bannerUrl, ENT_QUOTES, 'UTF-8') ?>');"><div class="content"><header><h2>Dien een klacht in</h2></header></div></section>
  <section id="complain" class="main style3 secondary">
    <div class="content">
      ...
      <div class="box">
        ...
        <form method="post" action="">
          ...
          <ul class="actions special"><li><input type="submit" value="Klacht indienen" /></li></ul>
        </form>
      </div>
    </div>
  </section>
