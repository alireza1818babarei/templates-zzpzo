...
</a><button class="menu-toggle" type="button">Menu</button><nav class="nav-links"><a class="" href="index.php">Startpagina</a><a class="" href="about.php">Over ons</a><a class="" href="service.php">Diensten</a><a class="" href="contact.php">Contact</a></nav></header><main><section class="section dynamic-fullwidth-section"><div class="bubble dynamic-content-panel dynamic-form-panel"><div class="dynamic-txt-content dynamic-form-text"><?php
