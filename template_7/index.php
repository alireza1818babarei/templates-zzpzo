...
<body>
  <header class="site-header"><a class="brand" href="index.php" id="brandLogo">
    ...
    <nav class="nav-links"><a class="active" href="index.php">Startpagina</a><a class="" href="about.php">Over ons</a><a
        class="" href="service.php">Diensten</a><a class="" href="contact.php">Contact</a></nav>
  </header>
  <main>
    <?php
