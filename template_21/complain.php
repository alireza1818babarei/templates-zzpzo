...
<html>
    <head>
        ...
        <link rel="stylesheet" href="assets/css/zz-mobile-footer.css?id=<?php echo filemtime('assets/css/zz-mobile-footer.css'); ?>" />
        <style>
            ...
            @media screen and (max-width:736px){.zz-dynamic-content,.box{height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important}.box input,.box textarea,.box button{max-width:100%;box-sizing:border-box}}
        </style>
    </head>
    <body class="is-preload">
        <div id="page-wrapper">
            <header id="header">
                <h1><a href="index.php" class="navbar-brand" id="brandLogo"><img src="logo.png?id=<?php echo filemtime('logo.png'); ?>" alt="Logo" onerror="this.remove();"></a></h1>
                <nav id="nav">
                    <ul>
            ...
            <section id="main" class="container medium">
                <header><h2>Klachtenportaal</h2></header>
                <div class="box">
                    <div class="zz-dynamic-content" style="text-align:left;">
                        <?php
                    ...
                    <form method="post" action="">
                        <div class="row gtr-50 gtr-uniform">
                            <div class="col-4 col-12-mobilep"><input type="text" name="name" id="name" value="<?php echo htmlspecialchars($formName, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Naam" maxlength="150" autocomplete="name" required /></div>
                            <div class="col-4 col-12-mobilep"><input type="text" name="phone" id="phone" value="<?php echo htmlspecialchars($formPhone, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Telefoon" maxlength="50" autocomplete="tel" /></div>
                            <div class="col-4 col-12-mobilep"><input type="email" name="email" id="email" value="<?php echo htmlspecialchars($formEmail, ENT_QUOTES, 'UTF-8'); ?>" placeholder="E-mail" maxlength="254" autocomplete="email" required /></div>
                            <div class="col-12"><textarea name="message" id="message" placeholder="Bericht" rows="6" maxlength="5000" required><?php echo htmlspecialchars($formMessage); ?></textarea></div>
                            <div class="col-12"><p>Deze site wordt beschermd door reCAPTCHA. Het <a href="privacy.php">privacybeleid</a> en de <a href="terms.php">algemene voorwaarden</a> van Google zijn van toepassing.</p></div>
                            <div class="col-12"><ul class="actions special"><li><input type="submit" value="Verzenden" /></li></ul></div>
                        </div>
                    </form>
                </div>
            </section>
