  ...
  <div class="tm-main-container">
    <div class="tm-top-container">
      <nav id="tmNav" class="tm-nav">
        ...
        <ul class="tm-nav-links open">
          <li class="tm-nav-item active"><a href="index.php" class="tm-nav-link">Startpagina</a></li>
    ...
    <main class="zz-main-content">
      <section class="zz-content-panel">
        <h2 class="tm-section-title mb-3 font-weight-bold">Startpagina</h2>
        <div class="tm-textbox tm-bg-dark zz-dynamic-content text-content zz-home-text-wrap">
          <?php
          $filePath = 'home.txt';
          if (file_exists($filePath)) {
            echo nl2br(htmlspecialchars(file_get_contents($filePath)));
