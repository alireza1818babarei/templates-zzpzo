...
<nav class="zz-fixed-menu">
  <div class="zz-menu-card">
    ...
    <ul class="zz-menu-links">
      ...
      <li><a href="about.php" title="Over ons" class="active"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 12a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm0 2c-4.42 0-8 2.24-8 5v1h16v-1c0-2.76-3.58-5-8-5Z"/></svg><span>Over ons</span></a></li>
    ...
    <div class="row zz-content-layout">
      <div class="col-xl-5 col-lg-6 tm-flex-center-v tm-text-container tm-section-left">
        <div class="zz-page-title">
          <h2 class="tm-color-secondary">Over ons</h2>
        </div>
