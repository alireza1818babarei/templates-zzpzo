...
<nav class="zz-fixed-menu">
  <div class="zz-menu-card">
    ...
    <ul class="zz-menu-links">
      <li><a href="index.php" title="Startpagina" class="active"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 11.5 12 4l9 7.5v8.5a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1z"/></svg><span>Startpagina</span></a></li>
