(function () {
  ...
  var css = [
    ...
    '  .zz-contact-text-panel .zz-dynamic-content { width: 100% !important; height: auto !important; max-height: none !important; overflow: visible !important; padding: 0 !important; line-height: 1.75 !important; box-sizing: border-box !important; }',
    '  .zz-contact-form-section { clear: both !important; display: block !important; position: relative !important; z-index: 2 !important; min-height: auto !important; margin-top: 26px !important; padding: 22px 0 70px !important; background: #fff !important; }',
    ...
    '  .zz-contact-text-panel .zz-dynamic-content { height: auto !important; max-height: none !important; overflow: visible !important; font-size: 16px !important; line-height: 1.65 !important; }',
    ...
    '  .zz-complain-content-card { padding: clamp(36px, 4vw, 62px); border: 1px solid rgba(0,149,191,0.08); border-radius: 18px; box-shadow: 0 14px 34px rgba(0,0,0,0.05); background: #fff; min-width: 0; height: auto; max-height: none; overflow: visible; }',
    '  .zz-complain-content-card h2 { margin-bottom: 24px; }',
    '  .zz-complain-content-card .zz-dynamic-content { color: #6c6c6c; line-height: 1.9; height: auto; max-height: none; overflow: visible; }',
    ...
    '  .zz-complain-content-card { order: 1; height: auto !important; max-height: none !important; overflow: visible !important; }',
    '  .zz-complain-content-card .zz-dynamic-content { height: auto !important; max-height: none !important; overflow: visible !important; }',
