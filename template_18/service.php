...
<nav class="zz-fixed-menu">
  <div class="zz-menu-card">
    ...
    <ul class="zz-menu-links">
      ...
      <li><a href="service.php" title="Diensten" class="active"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21 7.5 12 2 3 7.5v9L12 22l9-5.5Zm-9 2.1L6.5 6.4 12 3.1l5.5 3.3Zm-1 10.1-6-3.7V8.6l6 3.6Zm2 0v-7.5l6-3.6V16Z"/></svg><span>Diensten</span></a></li>
...
<?php
$defaultBanner = "img/spot-bg-02.jpg";
    ...
    <div class="row zz-content-layout">
      <div class="col-xl-5 col-lg-6 tm-flex-center-v tm-text-container tm-section-left">
        <div class="zz-page-title">
          <h2 class="tm-color-secondary">Diensten</h2>
        </div>
      ...
      <div class="col-xl-7 col-lg-6 tm-circle-img-container zz-content-image-wrap">
        <img src="<?php echo htmlspecialchars($bannerUrl); ?>" alt="Afbeelding" class="rounded-circle tm-circle-img zz-circle-image">
      </div>
    </div>
  </div>
</section>
