...
<?php
$defaultBanner = "img/input-bg-06.jpg";
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="tm-home-left zz-title-box">
                        <h1 class="tm-site-title">Diensten</h1>
                    </div>
...
<li class="d-flex justify-content-between align-items-center"><a href="service.php" class="tm-white-text font-weight-bold">Diensten</a></li>
