...
<head>
    ...
    <link rel="stylesheet"
        href="css/zz-responsive-fixes.css?id=<?php echo filemtime('css/zz-responsive-fixes.css'); ?>">
</head>
                    ...
                    <div class="zz-logo-box">
                        <a href="index.php" class="navbar-brand" id="brandLogo">
                            <img src="logo.png?id=<?php echo filemtime('logo.png'); ?>" alt="Logo"
                                style="width:50px;margin-top:-5px;" onerror="this.remove();">
                        </a>
                    </div>
                    <ul class="list-group tm-home-list zz-nav-list tm-bg-black font-weight-light">
                        <li class="d-flex justify-content-between align-items-center"><a href="index.php"
                                class="tm-white-text">Startpagina</a></li>
                        <li class="d-flex justify-content-between align-items-center"><a href="about.php"
                                class="tm-white-text">Over ons</a></li>
                        <li class="d-flex justify-content-between align-items-center"><a href="service.php"
                                class="tm-white-text">Diensten</a></li>
                        <li class="d-flex justify-content-between align-items-center"><a href="contact.php"
                                class="tm-white-text">Contact</a></li>
                    </ul>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 tm-login-l">
                    <form action="#" method="post" class="tm-bg-black p-5 h-100 zz-standard-form">
                        ...
                        <div class="text-right">
                            <button type="submit"
                                class="waves-effect btn-large btn-large-white px-4 black-text rounded-0">Verzenden</button>
                        </div>
                        <div class="zz-recaptcha-note">Deze site wordt beschermd door reCAPTCHA. Het <a
                                href="privacy.php">privacybeleid</a> en de <a href="terms.php">algemene voorwaarden</a>
                            van Google zijn van toepassing.</div>
                    </form>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 tm-login-r">
                    <header class="font-weight-light tm-bg-black p-5 h-100 zz-form-copy">
                        <h5 class="mt-0 text-white font-weight-light">Klachtenportaal</h5>
