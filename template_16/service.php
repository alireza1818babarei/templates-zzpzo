    ...
    <div id="tmSideBar" class="col-xl-3 col-lg-4 col-md-12 col-sm-12 sidebar">
      ...
      <div class="inner">
        ...
        <nav id="tmMainNav" class="tm-main-nav"><ul>
          <li><a href="index.php" class=""><i class="fas fa-home tm-nav-fa-icon"></i><span>Startpagina</span></a></li><li><a href="about.php" class=""><i class="fas fa-info-circle tm-nav-fa-icon"></i><span>Over ons</span></a></li><li><a href="service.php" class="active"><i class="fas fa-map tm-nav-fa-icon"></i><span>Diensten</span></a></li><li><a href="contact.php" class=""><i class="fas fa-comments tm-nav-fa-icon"></i><span>Contact</span></a></li>
        </ul></nav>
      </div>
    </div>
...
<section class="tm-section zz-content-box">
  <div class="ml-auto">
    <header class="mb-4"><h1 class="tm-text-shadow">Diensten</h1></header>
