      ...
      <div class="row tm-main-row">
        <div id="tmSideBar" class="col-xl-3 col-lg-4 col-md-12 col-sm-12 sidebar">
          ...
          <div class="inner">
            ...
            <nav id="tmMainNav" class="tm-main-nav">
              <ul>
                <li><a href="index.php" class="active"><i class="fas fa-home tm-nav-fa-icon"></i><span>Startpagina</span></a>
                </li>
                <li><a href="about.php" class=""><i class="fas fa-info-circle tm-nav-fa-icon"></i><span>Over ons</span></a></li>
        ...
        <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
          ...
          <section class="tm-section zz-content-box">
            <div class="ml-auto">
              <header class="mb-4">
                <h1 class="tm-text-shadow">Startpagina</h1>
              </header>
              <div class="mb-5 tm-font-big zz-dynamic-content text-content zz-home-text-wrap">
                <?php
                $filePath = 'home.txt';
                if (file_exists($filePath)) {
                  echo nl2br(htmlspecialchars(file_get_contents($filePath)));
