...
<body style="background-image: url('<?php echo htmlspecialchars($bannerUrl); ?>');">
  <div class="zz-page-shell">
        ...
        <div id="tmSideBar" class="col-xl-3 col-lg-4 col-md-12 col-sm-12 sidebar">
          ...
          <div class="inner">
            ...
            <nav id="tmMainNav" class="tm-main-nav">
              <ul>
                <li><a href="index.php" class=""><i class="fas fa-home tm-nav-fa-icon"></i><span>Startpagina</span></a>
                </li>
                <li><a href="about.php" class=""><i class="fas fa-info-circle tm-nav-fa-icon"></i><span>Over
                      ons</span></a></li>
                <li><a href="service.php" class=""><i class="fas fa-map tm-nav-fa-icon"></i><span>Diensten</span></a>
                </li>
                <li><a href="contact.php" class="active"><i
                      class="fas fa-comments tm-nav-fa-icon"></i><span>Contact</span></a></li>
              </ul>
            </nav>
          </div>
        </div>
          ...
          <section class="tm-section zz-form-box">
            <div class="tm-bg-transparent-black tm-contact-box-pad">
              <div class="row mb-4">
                <div class="col-sm-12">
                  <header>
                    <h2 class="tm-text-shadow">Neem contact op</h2>
                  </header>
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-12 tm-contact-col">
                  <div class="contact_message">
                    <form action="#" method="post" class="contact-form">
                      ...
                      <div class="form-group"><textarea name="message" class="form-control" rows="9"
                          placeholder="Bericht"></textarea></div>
                      <button type="submit" class="btn tm-btn-submit tm-btn">Verzenden</button>
                    </form>
                  </div>

                </div>
                <div class="zz-form-note">Deze site wordt beschermd door reCAPTCHA. Het <a
                    href="privacy.php">privacybeleid</a> en de <a href="terms.php">algemene voorwaarden</a> van
                  Google zijn van toepassing.</div>
              </div>
            </div>
          </section>
    ...
    <script type="text/javascript"
      src="js/jquery-3.2.1.min.js?id=<?php echo filemtime('js/jquery-3.2.1.min.js'); ?>"></script>
    <script type="text/javascript"
      src="js/jquery.magnific-popup.min.js?id=<?php echo filemtime('js/jquery.magnific-popup.min.js'); ?>"></script>
