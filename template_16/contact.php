...
<section class="tm-section zz-form-box">
  <div class="tm-bg-transparent-black tm-contact-box-pad">
    <div class="row mb-4">
      <div class="col-sm-12"><header><h2 class="tm-text-shadow">Neem contact op</h2></header></div>
    </div>
