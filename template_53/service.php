...
<body>
  <header class="site-header">
    ...
    <nav class="nav" id="primaryNav"><a href="index.php"><span>Home</span></a><a href="about.php"><span>About Us</span></a><a href="service.php" class="active"><span>Services</span></a><a href="contact.php"><span>Contact</span></a></nav>
  </header>
  <main>
  <?php
