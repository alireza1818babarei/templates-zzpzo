...
<html lang="nl">
	<head>
		...
		<style>
			...
			@media screen and (max-width:736px){.zz-dynamic-content{height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important}}
		</style>
	</head>
	<body class="is-preload zz-static-page zz-form-page">
		<div id="wrapper">
			<header id="header">
				<div class="logo"><a href="index.php" class="navbar-brand" id="brandLogo" style="width: 100%; height: 100%; border-bottom: 0; display: flex; align-items: center; justify-content: center;"><img src="logo.png?id=<?= $version ?>" alt="Logo" style="width:100%;" onerror="this.remove();"></a></div>
				<div class="content"><div class="inner"><h1><?= htmlspecialchars($siteTitle, ENT_QUOTES, 'UTF-8') ?></h1><p>Klachtenportaal</p></div></div>
				<nav><ul><li><a href="index.php">Startpagina</a></li><li><a href="about.php">Over ons</a></li><li><a href="service.php">Diensten</a></li><li><a href="contact.php">Contact</a></li></ul></nav>
			</header>
			<div id="main">
				<article id="complain">
					...
					<form method="post" action="">
						<div class="fields">
							<div class="field half"><label for="name">Naam</label><input type="text" name="name" id="name" value="<?php echo htmlspecialchars($formName, ENT_QUOTES, 'UTF-8'); ?>" maxlength="150" autocomplete="name" required /></div>
							<div class="field half"><label for="email">E-mail</label><input type="email" name="email" id="email" value="<?php echo htmlspecialchars($formEmail, ENT_QUOTES, 'UTF-8'); ?>" maxlength="254" autocomplete="email" required /></div>
							<div class="field"><label for="phone">Telefoon</label><input type="text" name="phone" id="phone" value="<?php echo htmlspecialchars($formPhone, ENT_QUOTES, 'UTF-8'); ?>" maxlength="50" inputmode="tel" autocomplete="tel" /></div>
							<div class="field"><label for="message">Bericht</label><textarea name="message" id="message" rows="6" maxlength="5000" required><?php echo htmlspecialchars($formMessage); ?></textarea></div>
						</div>
						...
						<ul class="actions"><li><input type="submit" value="Klacht verzenden" class="primary" /></li><li><input type="reset" value="Herstellen" /></li></ul>
					</form>
				</article>
			</div>
			<footer id="footer"><p class="copyright"><a href="terms.php">Algemene voorwaarden</a> &nbsp;|&nbsp; <a href="complain.php">Klachtenportaal</a> &nbsp;|&nbsp; <a href="privacy.php">Privacybeleid</a><br />Auteursrecht &copy; <?= date('Y') ?> ZZpzo</p></footer>
		</div>
		<div id="bg"></div>
