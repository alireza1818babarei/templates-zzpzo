	...
	<body class="is-preload zz-static-page zz-form-page">
		<div id="wrapper">
			<header id="header">
				...
				<div class="content"><div class="inner"><h1><?= htmlspecialchars($siteTitle, ENT_QUOTES, 'UTF-8') ?></h1><p>Contact</p></div></div>
			...
			<div id="main">
				<article id="contact">
					...
					<form method="post" action="">
						...
						<ul class="actions"><li><input type="submit" value="Bericht verzenden" class="primary" /></li><li><input type="reset" value="Herstellen" /></li></ul>
					</form>
				</article>
			</div>
