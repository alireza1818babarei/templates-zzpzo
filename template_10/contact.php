...
<body class="is-preload zz-form-page">
	...
	<div id="wrapper">
		...
		<section id="banner" class="style2">
			<div class="inner">
				<span class="image"><img src="<?= htmlspecialchars($pageImage, ENT_QUOTES, 'UTF-8') ?>" alt="Contact" /></span>
				<header class="major"><h1>Contact</h1></header>
			</div>
		</section>
