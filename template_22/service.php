...
<html>
	...
	<body class="is-preload">
		...
		?>
		<!-- Diensten -->
			<section id="two" class="main style2 left dark fullscreen" style="background-image: url('assets/css/images/overlay.png'), url('<?= htmlspecialchars($bannerUrl) ?>');">
		...
		<!-- Diensten Content -->
			<section id="service-content" class="main style3 primary">
				<div class="content">
					<p><?php
