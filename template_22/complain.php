...
<section id="contact" class="main style3 secondary" style="min-height:calc(100vh - 6em);"><div class="content"><header><h2>Klachtenportaal</h2><div class="zz-dynamic-content"><?php $filePath='complain.txt';if(file_exists($filePath)){echo nl2br(htmlspecialchars(file_get_contents($filePath)));}else{echo '-';} ?></div></header><div class="box">
