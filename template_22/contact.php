...
<html>
	...
	<body class="is-preload">
		...
		<?php
		$defaultBanner = "images/intro.jpg";
		...
		?>
		<!-- Contact Header -->
			<section id="intro" class="main style1 dark fullscreen" style="background-image: url('assets/css/images/overlay.png'), url('<?= htmlspecialchars($bannerUrl) ?>');">
				<div class="content">
					<header>
						<h2>Contact</h2>
					</header>
		...
		<!-- Contact Content -->
			<section id="contact-content" class="main style3 primary">
				<div class="content">
					<p><?php
