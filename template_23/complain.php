	...
	<body class="template-page no-hero">
		<div id="wrapper">
			<header id="header" class="compact">
				<a href="index.php" class="logo navbar-brand" id="brandLogo"><img src="logo.png?id=<?php echo filemtime('logo.png'); ?>" alt="Logo" onerror="this.remove();"></a>
				<nav class="use-middle"><ul><li><a href="index.php">Startpagina</a></li><li><a href="about.php">Over ons</a></li><li class="is-middle"><a href="service.php">Diensten</a></li><li><a href="contact.php">Contact</a></li></ul></nav>
			</header>
			<section class="page-section simple-page"><div class="section-inner">
				<h2 class="major">Klachtenportaal</h2>
				<div class="page-copy"><?php $filePath='complain.txt';if(file_exists($filePath)){echo nl2br(htmlspecialchars(file_get_contents($filePath)));}else{echo '-';} ?></div>
