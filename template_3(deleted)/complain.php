...
-->
  ...
  transition: all 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275);">Terms</a>
              <a href="privacy.php" class="nav__link c-blue"  style="color: #fff !important;margin-top: 30px;background: none;height: 50px;  text-decoration: none;">Privacy</a>
              <a href="complain.php" class="nav__link c-blue"  style="color: #fff !important;margin-top: 60px;background: none;height: 50px;  text-decoration: none;">Complain</a>
...
?>
        ...
        <section class="panel" id="1" style="background: #3E4E62;">
