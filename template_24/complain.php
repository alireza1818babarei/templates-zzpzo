...
<body class="is-preload no-hero-page complain-page">
...
<section id="page-content" class="main"><header><div class="container"><h2>Klachtenportaal</h2></div></header><div class="content style4 featured"><div class="container medium">
<section class="dynamic-content"><?php $filePath='complain.txt';if(file_exists($filePath)){echo nl2br(htmlspecialchars(file_get_contents($filePath)));}else{echo '-';} ?></section>
