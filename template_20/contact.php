...
<body>
  ...
  <main>
    ...
    <?php
    $defaultBanner = "images/ivory-flow-61.jpg";
    ...
    <section class="zz-hero-section">
      <div class="zz-hero-image">
        <img src="<?php echo htmlspecialchars($bannerUrl); ?>" alt="Contact" loading="eager">
      </div>
      <div class="zz-hero-content">
        <h1 class="zz-hero-title">Contact</h1>
      </div>
    </section>
    ...
    <section class="zz-form-section">
      <div class="zz-form-grid zz-form-grid-single">
        <div class="zz-form-card">
          ...
          <div class="zz-recaptcha">Deze site wordt beschermd door reCAPTCHA. Het <a
