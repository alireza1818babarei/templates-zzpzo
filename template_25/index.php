...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=DM+Mono:wght@300;400&family=Playfair+Display:ital,wght@0,700;0,800;0,900;1,700&family=Instrument+Sans:wght@400;500;600&display=swap"
    rel="stylesheet">
...
<body>
  <?php
  $defaultBanner = "images/templatemo-split-01.jpg";
  ...
  <header class="site-header">
    ...
    <nav class="site-header-nav" id="siteHeaderNav">
      <a href="index.php" class="nav-active">Startpagina</a>
  ...
  <div class="split-container">
    <div class="left-side">
      <div class="panel panel-active">
        <div class="page-content">
          <span class="about-label">Startpagina</span>
    ...
    <div class="canvas-side" id="canvasSide">
      <div class="canvas-context visible page-hero-image">
        <img src="<?= htmlspecialchars($bannerUrl) ?>" alt="Startpagina" loading="lazy">
        <div class="canvas-context-overlay">
          <p class="canvas-context-quote">Startpagina</p>
