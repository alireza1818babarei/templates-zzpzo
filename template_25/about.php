...
<body>
<?php
$defaultBanner = "images/templatemo-split-09.jpg";
...
<header class="site-header">
  ...
  <nav class="site-header-nav" id="siteHeaderNav">
    ...
    <a href="about.php" class="nav-active">Over ons</a>
  ...
  <div class="left-side">
    <div class="panel panel-active">
      <div class="page-content">
        <span class="about-label">Over ons</span>
...
?>
  ...
  <div class="canvas-side" id="canvasSide">
    <div class="canvas-context visible page-hero-image">
      <img src="<?= htmlspecialchars($bannerUrl) ?>" alt="Over ons" loading="lazy">
      <div class="canvas-context-overlay">
        <p class="canvas-context-quote">Over ons</p>
